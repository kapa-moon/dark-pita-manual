    ...
    <div className="App">
      ...
      <ul style={listStlying}>
        <li>
          ...
          <span className="Highlight">
            ...
            ></img>
          </span>(you might need to click {''}<span className="Highlight"> <svg
            t="1660817091111"
            class="icon"
            viewBox="0 0 1024 1024"
            version="1.1"
      ...
      <ol style={orderListStlying}>
        ...
        <li>
          ...
          (you might need to click {''}<span className="Highlight"> <svg
            t="1660817091111"
            class="icon"
            viewBox="0 0 1024 1024"
            version="1.1"
          ...
          {''}first) and click the <span className="Highlight">Open Banner</span> button.
        </li>
      </ol>
